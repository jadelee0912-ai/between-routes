...
export default function CulturalJourneysPage() {
  ...
  const pagePath = "/china-cultural-journeys";
  ...
  return (
    <div className="min-h-screen bg-stone-50 text-stone-900">
      <Helmet>
        <title>{t("culturalPage.seo.title")}</title>
        <meta name="description" content={t("culturalPage.seo.description")} />
        ...
        <meta property="og:title" content={t("culturalPage.seo.title")} />
        <meta property="og:description" content={t("culturalPage.seo.description")} />
        ...
        <meta name="twitter:title" content={t("culturalPage.seo.title")} />
        <meta name="twitter:description" content={t("culturalPage.seo.description")} />
        ...
        <script type="application/ld+json">{`
          {
            ...
            "name": "Between Routes",
            "url": "${canonicalUrl}",
            "description": "${t("culturalPage.seo.description")}",
            "areaServed": "China",
          ...
          <div className="py-20 md:py-28">
            <div className="max-w-3xl">
              <div className="mb-5 inline-flex rounded-full border border-white/30 bg-white/10 px-4 py-1.5 text-xs uppercase tracking-[0.16em] text-white/90 backdrop-blur">
                {t("culturalPage.badge")}
              </div>
              <h1 className="text-4xl font-semibold leading-tight tracking-tight md:text-6xl">
                {t("culturalPage.title")}
              </h1>
      ...
      <section className="mx-auto max-w-7xl px-6 py-20">
        <div className="grid gap-10 md:grid-cols-2">
          <div>
            <div className="text-sm uppercase tracking-[0.18em] text-stone-500">{t("culturalPage.sectionLabel")}</div>
            <h2 className="mt-4 text-3xl font-semibold tracking-tight md:text-5xl">
              {t("culturalPage.sectionTitle")}
            </h2>
          </div>
          <div className="space-y-5 text-base leading-8 text-stone-700">
            <p>{t("culturalPage.p1")}</p>
            <p>{t("culturalPage.p2")}</p>
            <p>{t("culturalPage.p3")}</p>
          </div>
        </div>

        <div className="mt-14 grid gap-6 md:grid-cols-3">
          {[
            t("culturalPage.feature1"),
            t("culturalPage.feature2"),
            t("culturalPage.feature3"),
          ].map((item) => (
      ...
      <section className="border-y border-stone-200 bg-white">
        <div className="mx-auto max-w-7xl px-6 py-20">
          <div className="max-w-2xl">
            <div className="text-sm uppercase tracking-[0.18em] text-stone-500">{t("culturalPage.ideasLabel")}</div>
            <h2 className="mt-4 text-3xl font-semibold tracking-tight md:text-5xl">
              {t("culturalPage.ideasTitle")}
            </h2>
          </div>
          ...
          <div className="mt-12 grid gap-6 md:grid-cols-3">
            {[
              {
                title: t("culturalPage.idea1.title"),
                desc: t("culturalPage.idea1.desc"),
              },
              {
                title: t("culturalPage.idea2.title"),
                desc: t("culturalPage.idea2.desc"),
              },
              {
                title: t("culturalPage.idea3.title"),
                desc: t("culturalPage.idea3.desc"),
              },
            ].map((item) => (
      ...
      <section className="mx-auto max-w-7xl px-6 py-20">
        <div className="grid gap-10 md:grid-cols-[0.95fr_1.05fr] md:items-start">
          <div>
            <div className="text-sm uppercase tracking-[0.18em] text-stone-500">{t("culturalPage.formLabel")}</div>
            <h2 className="mt-4 text-3xl font-semibold tracking-tight md:text-5xl">
              {t("culturalPage.formTitle")}
            </h2>
            <p className="mt-5 max-w-lg text-base leading-8 text-stone-700 md:text-lg">
              {t("culturalPage.formSubtitle")}
            </p>
          </div>
          ...
          <form className="rounded-[32px] border border-stone-200 bg-white p-8 shadow-sm" onSubmit={handleSubmit}>
            ...
            <div className="mt-5">
              <textarea name="details" rows={5} placeholder={t("culturalPage.detailsPlaceholder")} className="w-full rounded-2xl border border-stone-300 px-4 py-3 outline-none focus:border-stone-900" />
            </div>
      ...
      <footer className="border-t border-stone-200 bg-white">
        <div className="mx-auto max-w-7xl px-6 py-10">
          ...
          <div className="mt-8 pt-6 border-t border-stone-100 flex flex-col gap-2 md:flex-row md:justify-between text-xs text-stone-400">
            ...
            <Link to={lp("/")} className="hover:text-stone-600">{t("footer.tagline")}</Link>
          </div>
        </div>
      </footer>
    </div>
