...
// 👉 Collez ici les liens des comptes une fois créés. Vide = l'icône ne s'affiche pas.
const SOCIALS = {
  whatsapp: WHATSAPP_LINK,
  facebook: "", // ex : https://www.facebook.com/votrepage
  instagram: "", // ex : https://www.instagram.com/votrecompte
  tiktok: "", // ex : https://www.tiktok.com/@votrecompte
};
...
const SOCIAL_LABELS = { whatsapp: "WhatsApp", facebook: "Facebook", instagram: "Instagram", tiktok: "TikTok" };
              ...
              {Object.keys(SOCIALS)
                ...
                .map((k) => (
                  <a
                    ...
                    onClick={() => window.brTrack?.("social_click", { network: k })}
                    className="flex h-9 w-9 items-center justify-center rounded-full bg-white/10 text-white/60 transition hover:bg-amber-700 hover:text-white"
                  >
